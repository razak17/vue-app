<template>
    <form v-if="!loading" v-on:submit.prevent="onSubmit" class="form" action="">
        ...
        <div class="input-field">
            ...
            <span
                class="helper-text"
                data-error="Body must not be empty"
            ></span>
...
export default {
    ...
    methods: {
        ...
        validForm() {
            this.errors = {};
            if (this.title.trim() === '') {
                this.errors.title = 'Title please';
            }
            if (this.body.trim() === '') {
                this.errors.body = 'Body please';
            }
